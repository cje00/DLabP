...
며칠인지를 나타내는 day와 그날 주차장에 들어오려고 하는 차들의 번호를 담고 있는
리스트 numbers가 매개변수로 주어질 때, 주차장에 들어올 수 있는 차량의 수를
...
#####매개변수 설명
며칠인지를 나타내는 day와 그날 주차장에 들어오려고 하는 차들의 번호를 담고 있는
리스트 numbers가 solution 함수의 매개변수로 주어집니다.
...
def solution(day, numbers):
    ...
    for number in numbers:
        if number%2 == day%2:  #(*should be == not =)/ before -> if number%2 != day%2:
            count += 1
    return count
